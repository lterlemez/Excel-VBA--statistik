...
Bu depoda, VBA makro örneklerimi göstereceğim. Şu anda, **istatistik** (yalnızca İngilizce ve Türkçe açıklaması da olacak) ve **ki-kare** (kodlar dışında hiçbir şeyi olmayan) olmak üzere yalnızca iki farklı çalışan alt dizin var. **VBA_Statistics** için [burayı](./VBA_Statistics/README(TUR).md) ve **VBA_ChiSquare** için [burayı](./VBA_ChiSquare/README.md) tıklayabilirsiniz.
